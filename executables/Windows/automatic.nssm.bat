...
:: - Model Path
set model_path=%user_path%\Desota\Desota_Models\automatic

:: - NSSM VARS
set nssm_path=%user_path%\Desota\Portables\nssm

:: Service VARS - retrieved from https://nssm.cc/usage
set model_display_name=spacewalkingninja/automatic
set service_name=desota_stable_difusion_service
set exe_path=%model_path%\executables\Windows
set model_exe=%exe_path%\automatic.service.bat
set model_exe_args=
set model_desc=Automatic SD.Next for DeSOTA 
